...
ActiveRecord::Schema.define(version: 2020_03_13_151959) do
  ...
  create_table "sstudents", id: :integer, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "surname"
    t.integer "grade"
    t.datetime "created_at", null: false
